                    ...
                    if 'benchmark_data' in locals() and not benchmark_data.empty:
                        ...
                        if fund_stress_result['data_available']:
                            ...
                            if fund_stress_result['outperformed_benchmark']:
                                st.success(f"✅ **This fund was resilient!** It outperformed the benchmark during {selected_scenario_sf['name']}.")
                            else:
                                st.warning(f"⚠️ **This fund was sensitive.** It underperformed the benchmark during {selected_scenario_sf['name']}.")
